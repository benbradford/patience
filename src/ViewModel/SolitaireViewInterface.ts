...
export default abstract class  SolitaireViewInterface {
    ...
    public abstract floating_cards(): FloatingCards;
    ...
    public abstract deck(): Readonly<IPileView>;
    public abstract turned(): Readonly<IPileView>;
    public abstract hold(): Readonly<IPileView[]>;
    public abstract score(): Readonly<IPileView[]>;
